...
<section class="section section-show-all">
    <div class="container">
        ...
        <div>
            <a style="text-transform: capitalize !important;" class="btn btn-info back-button" href="${pageContext.request.contextPath}/app/admin"><fmt:message key="back" bundle="${messages}"/></a>
        </div>

        <div class="section__inner section-show-all">
            <div class="section-show-all__add-button">
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/app/admin/nurses/create"><fmt:message key="newNurse" bundle="${messages}"/></a>
            </div>
